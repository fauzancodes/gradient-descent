...
def gradient_descent(x, y, slope, intercept, learning_rate, minimum_gradient, maximum_iterations, mini_batch) :
    ...
    while looping == "continue" :
        ...
        gradient_slope = (np.sum(-2 * x_random * (y_random - ((slope * x_random) + intercept)))) / len(x)
        gradient_intercept = (np.sum(-2 * (y_random - ((slope * x_random) + intercept)))) / len(x)
...
slope, intercept, gradient_slope, gradient_intercept, tot_gradient_slope, tot_gradient_intercept, tot_slope, tot_intercept, tot_mse, learning_rate = gradient_descent(x, y, slope, intercept, learning_rate, minimum_gradient, maximum_iterations, mini_batch)
