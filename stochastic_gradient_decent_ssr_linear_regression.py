...
def gradient_descent(x, y, slope, intercept, learning_rate, minimum_gradient, maximum_iterations) :
    ...
    while looping == "continue" :
        ...
        gradient_slope = -2 * x_random * (y_random - ((slope * x_random) + intercept))
        gradient_intercept = -2 * (y_random - ((slope * x_random) + intercept))
...
slope, intercept, gradient_slope, gradient_intercept, tot_gradient_slope, tot_gradient_intercept, tot_slope, tot_intercept, tot_ssr, learning_rate = gradient_descent(x, y, slope, intercept, learning_rate, minimum_gradient, maximum_iterations)
